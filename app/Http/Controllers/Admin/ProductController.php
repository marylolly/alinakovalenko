...
class ProductController extends Controller {
    ...
    {
        $product = Product::with("category")->with("user")->get();
...
$user = User::pluck("name", "id")->prepend('Please select', 0);
	    ...
	    return view('admin.product.create', compact("category", "user"));
	}
...
$user = User::pluck("name", "id")->prepend('Please select', 0);
		...
		return view('admin.product.edit', compact('product', "category", "user"));
	}
